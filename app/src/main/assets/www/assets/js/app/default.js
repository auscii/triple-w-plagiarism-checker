var userId = localStorage.getItem('id'),
    ...
    reviewPaperEventPlace = localStorage.getItem('reviewPaperEventPlace'),
    reviewPaperEventDate = localStorage.getItem('reviewPaperEventDate'),
    reviewPaperEventTime = localStorage.getItem('reviewPaperEventTime'),
    reviewPaperDescription = localStorage.getItem('reviewPaperDescription'),
    reviewPaperCategory = localStorage.getItem('reviewPaperCategory'),
    reviewPaperAbstractSubmission = localStorage.getItem('reviewPaperAbstractSubmission'),
    reviewPaperFullPaperSubmission = localStorage.getItem('reviewPaperFullPaperSubmission'),
    reviewPaperAveragePercentageReport = localStorage.getItem('reviewPaperAveragePercentageReport'),
    reviewPaperNumberPapersAccomodated = localStorage.getItem('reviewPaperNumberPapersAccomodated'),
    reviewPaperAllowPaperApplication = localStorage.getItem('reviewPaperAllowPaperApplication'),
    reviewPaperModeOfReview = localStorage.getItem('reviewPaperModeOfReview'),
    reviewPaperDateTimeCreated = localStorage.getItem('reviewPaperDateTimeCreated'),
    reviewPaperPublishedBy = localStorage.getItem('reviewPaperPublishedBy'),
    reviewPaperSubscriberEmail = localStorage.getItem('reviewPaperSubscriberEmail'),
    reviewPaperLikes = localStorage.getItem('reviewPaperLikes'),
    reviewPaperStatus = localStorage.getItem('reviewPaperStatus'),
    ...
    approved = "Approved",
    returned = "Returned", //conference chair - Returned - accepted, Returned - rejected, Returned - Revisions
